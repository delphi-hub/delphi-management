...
export class TableNotificationCrawlerDataSource extends DataSource<TableNotificationCrawlerItem> {
   ...
   */
  connect(): Observable<TableNotificationCrawlerItem[]> {
   ...
   */
  private getPagedData(data: TableNotificationCrawlerItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TableNotificationCrawlerItem[]) {
