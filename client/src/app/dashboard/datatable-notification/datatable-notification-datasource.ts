...
/**
 * Data source for the DatatableNotification view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class DatatableNotificationDataSource extends DataSource<DatatableNotificationItem> {
  data: DatatableNotificationItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<DatatableNotificationItem[]> {
   ...
   */
  private getPagedData(data: DatatableNotificationItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: DatatableNotificationItem[]) {
...
/** Simple sort comparator for example Name/Date-Time columns (for client-side sorting). */
